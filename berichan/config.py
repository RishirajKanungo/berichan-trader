...
# Only read a local .env during development. A packaged (PyInstaller) build must
# NOT pick up a stray .env from the working directory — distributed copies have
# no developer credentials and rely solely on the per-user settings.json.
